...
public class BusinessEntity extends AbstractMapElement
    ...
    @Override public List<TimeSeriesEntry> getAllTimeSeriesEntries() {
        return null;
    }
    ...
    @Override public void addAllTimeSeriesEntries(List<TimeSeriesEntry> entries, boolean checkNested) {
